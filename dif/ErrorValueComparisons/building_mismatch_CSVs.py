        ...
        if alma_record[0] == dlxs_record[0]:
            for mismatch_record in mismatches:
                if alma_record[0] == dlxs_record[0] == mismatch_record[0]:
                    ...
                    if "publication place" in mismatch_record[3]:
                    ...
                    #checking publisher
                    if "publisher" in mismatch_record[3]:
                    ...
                    if "publication date" in mismatch_record[3]:
                    ...
                    #checking keywords
                    if "keywords" in mismatch_record[3]:
